...
@"v10" = global i32 0
; Variable Name: TMP
@"v14" = global <2 x i32> <i32 0,i32 0>
...
%"v16" = alloca i32
; Variable Name: TMP
%"v14_raw" = call i8* @"malloc"(i32 2)
%"v14" = bitcast i8* %"v14_raw" to i32*
%"v14.0" = getelementptr i32, i32* %"v14", i32 1
%"v14.1" = getelementptr i32, i32* %"v14", i32 2
%"v14.2" = getelementptr i32, i32* %"v14", i32 3
; Variable Name: VAL
%"v13" = alloca i32
...
%t24 = load <2 x i32>, <2 x i32>* @"v14"
%t25 = insertelement <2 x i32> %t24, i32 %t23, i32 %t22
store <2 x i32> %t25,<2 x i32>* @"v14"
...
; Begin array
; make more generic  with currentElement.value.llvm_type
%t28 = load <2 x i32>, <2 x i32>* @"v14"
%t29 = insertelement <2 x i32> %t28, i32 %t27, i32 %t26
store <2 x i32> %t29,<2 x i32>* @"v14"
; Done with assign to array
; Begin Loop
; Integer Value: 0
%t30 = add i32 0 , 0
; Integer Value: 0
%t31 = add i32 0 , 0
store i32 %t31, i32* %"v15"
br label %"label_4"
label_4:
; Integer Value: 0
%t32 = add i32 0 , 0
;Found Variable! :LOOPVAL
%t33= load i32, i32* %v15
; Integer Value: 0
%t34 = add i32 0 , 0
;Found Variable! :VAL
%t35= load i32, i32* %v13
...
;Found Variable! :TMP
; Reading from Array
%t42 = load <2 x i32>, <2 x i32>* @"v14"
; for error checking make sure that the returned index value is an int
%t43 = extractelement <2 x i32> %t42, i32 %t41
%t44 = add i32 %t40 , %t43
store i32 %t44, i32* %"v16"
; Integer Value: 0
%t45 = add i32 0 , 0
; Integer Value: 1
%t46 = add i32 0 , 1
;Found Variable! :TMP
; Reading from Array
%t47 = load <2 x i32>, <2 x i32>* @"v14"
; for error checking make sure that the returned index value is an int
%t48 = extractelement <2 x i32> %t47, i32 %t46
; Begin array
; make more generic  with currentElement.value.llvm_type
%t49 = load <2 x i32>, <2 x i32>* @"v14"
%t50 = insertelement <2 x i32> %t49, i32 %t48, i32 %t45
store <2 x i32> %t50,<2 x i32>* @"v14"
; Done with assign to array
; Integer Value: 1
%t51 = add i32 0 , 1
; Integer Value: 0
%t52 = add i32 0 , 0
;Found Variable! :RET
%t53= load i32, i32* %v16
; Begin array
; make more generic  with currentElement.value.llvm_type
%t54 = load <2 x i32>, <2 x i32>* @"v14"
%t55 = insertelement <2 x i32> %t54, i32 %t53, i32 %t51
store <2 x i32> %t55,<2 x i32>* @"v14"
; Done with assign to array
; Integer Value: 0
%t56 = add i32 0 , 0
; Integer Value: 0
%t57 = add i32 0 , 0
;Found Variable! :LOOPVAL
%t58= load i32, i32* %v15
%t59 = add i32 %t58 , 1
store i32 %t59, i32* %"v15"
br label %"label_4"
label_6:
; Integer Value: 0
%t60 = add i32 0 , 0
;Found Variable! :RET
%t61= load i32, i32* %v16
ret i32 %t61
}
